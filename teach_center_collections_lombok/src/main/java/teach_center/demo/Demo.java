...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        Address address = new Address("Chernihiv", "Victory", 22, 32, 12);
        Teacher teacher = new Teacher("Ivav Pypkov", 43,"ivanich@daideneg.com","PhysMat","Rector", address);
        ...
        Student student = new Student("fdw", 19, "fwfw", subjects, 3, "denna", days, subjectSet, address);
